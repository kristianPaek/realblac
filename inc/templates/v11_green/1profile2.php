...
<td width="100%"><p><strong><font size="4"><?=substr($profileUsername,0,30) ?> </font></strong></p>
Last login <?=showTimeSince($MyProfileGlobals['lastlogin']) ?>
<BR /><BR />
</td></tr>
...
<h1 style="margin-top:1px;width:405px;"><?=$LANG_ACCOUNT_MENU['video'] ?></h1>
  ...
  <? } ?>	  
<BR />
<center><a href="javascript:void(0);" onclick="NewpopUpWin('<?=DB_DOMAIN ?>inc/exe/slideshow/slideshow.php?id=<?=$profileId ?>', 500, 500);return false;"><b><U>View my Photoshow</U></b></a></center>
