...
<td width="1150" valign="top" style="height:121px;">
		...
		<div id="ProfileUsernameBox" style="height:2px;">
...
<tr>
<td width="100%"><p><strong><font size="6"><?=substr($profileUsername,0,30) ?> </font></strong></p>
...
</div></td><td width="150" valign="top">
...
<br /><br /><center>
<a href="javascript:void(0);" onclick="NewpopUpWin('<?=DB_DOMAIN ?>inc/exe/slideshow/slideshow.php?id=<?=$profileId ?>', 500, 500);return false;"><b><U>View my Photo Slideshow</U></b></a></center>
	...
	*/
	...
	<? if(!isset($BLOCKPAGEACCESS)){ ?>
		...
		<script type="text/javascript">
			...
			var so = new SWFObject(noCacheIE("<?=DB_DOMAIN ?>inc/exe/flash/profile_image.swf"), "ProfileImage", "500", "650", "12", "<?=$F1bg ?>");
