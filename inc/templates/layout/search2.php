...
?>
		...
		<? if(D_FRIENDS ==1){ ?><a href="<?=DB_DOMAIN ?>index.php?dll=search&friendid=<?=$_SESSION['uid'] ?>&displaytype=detail"><span><?=$GLOBALS['_LANG']['_my'] ?> <?=$GLOBALS['_LANG']['_friendsList'] ?> (<?=$MyFriends[1]['total'] ?>)</span></a>   -<? } ?>
