...
.profile_box_title { padding:7px; 	font-size:12px;}
...
<? } ?>
<div id="ProfileHead">
<table width="650" border="0" cellpadding="0" cellspacing="0"><tr><td width="407" valign="top" style="height:121px;">

		<div id="ProfileUsernameBox" style="height:5px;">
...
<div style="background:white; width:430px; min-height:500px" id="Profile_MainBar">
...
<div class="profile_box_body marginTop">
 <table width="100%"  border="0">
  <tr><p><b><?=$MyProfileGlobals['name']; ?></b></p>

    <td width="100%">Username: <strong><?=substr($profileUsername,0,30) ?> </strong></td>
  </tr>

<? if(D_MOD_WRITE ==1){ ?>
  <tr>
    <td><strong><?=$GLOBALS['_LANG']['_pLink'] ?></strong></td>
    <td><a href="<?=DB_DOMAIN.$MyProfileGlobals['username'] ?>" target="_blank" style="color:#666666"><strong><?=DB_DOMAIN.$MyProfileGlobals['username'] ?></strong></a></td>
  </tr>
<? } ?>
</table>
...
<? if(D_FRIENDS ==1222){ ?>
	...
	*/
	...
	<div class="pImage"><a href="<?=$value['link']; ?>"><img src="<?=$value['image']; ?>" border="0" width="48" height="48" class="pImageBorder"></a><div class="pImageUsername"><?=$value['username']; ?></div></div>
	<? } }  ?>
...
/**
	...
	<? foreach($RecentPhotos as $value){ ?>	<a href="<?=$value['link'] ?>"><img src="<?=$value['image'] ?>&x=74&y=74"  width="85" height="130"></a>	<? } ?>	 
...
<div id="ProfileOptionsBox"><center>More Than Dating. <BR />Building Relationships.<br /><br /></center>
 <div id="ProfileImage"></div><br>
...
<center><a <? if($_SESSION['auth'] =="yes"){  if(is_array($PACKAGEACCESS[$_SESSION['packageid']]) && !in_array("messages-create",$PACKAGEACCESS[$_SESSION['packageid']])){ ?> href="<?=DB_DOMAIN ?>index.php?dll=messages&sub=create&n=Admin&msg_subject=I want to report <?=$profileUsername ?>" <? }else{ ?> href="<?=DB_DOMAIN ?>index.php?dll=subscribe" <? } ?> <? }else{ ?> href="<?=DB_DOMAIN ?>index.php?dll=login" <? } ?>  class="pLink">Report Member</a></center><hr>
   <? } ?>
		...
		<div style="min-height:500px; background:white; display:block;">
...
<center>
		...
		<h1 style="margin-top:10px;width:205px;"><?=$LANG_ACCOUNT_MENU['video'] ?></h1>
		<div id='preview'></div>
		<script type='text/javascript' src='<?=DB_DOMAIN ?>inc/js/swfobject.js'></script>
	...
	*/
	...
	<? if(!empty($show_album_array)){ foreach($show_album_array as $value){ ?>
 	...
 	<li style="height:65px;margin-top:7px;">
		...
		<a href="<?=$value['link'] ?>"><b>View All Photos</b><br><?=substr($value['comment'],0,100); ?></a>
	...
	*/
	...
	<h1 style="width:205px;margin-top:10px;"><?=$GLOBALS['_LANG']['_information'] ?></h1>
...
</td><td width="16" valign="top" style="height:121px;"><img src="<?=DB_DOMAIN ?>images/DEFAULT/blank.gif" width="1" height="1">

  <div style="background:white; margin-top:165px; width:16px; min-height:600px;"><img src="<?=DB_DOMAIN ?>images/DEFAULT/blank.gif" width="1" height="1"></div></td>
</tr>
</table>
