    ...
    if($device['os'] == "iOS") {
        ...
        if ($fp) {
           ...
           $body['aps'] = array(
            ...
            //$message22 = array("body"=>array("alert" => $message, "user_id" => $user_id, "user_name" => $username['username'],"type" => $type));
        ...
        $message = array("body"=>array("alert" => $message, "user_id" => $user_id, "user_name" => $username['username'],"type" => $type));
