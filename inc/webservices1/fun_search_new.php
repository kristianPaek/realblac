...
//print_r($UserData);
    ...
    $QueryTotal .=" WHERE members.email !='' AND members.visible = 'yes' AND members.id NOT IN('".$UserDataM."')";
...
//print_r($QueryTotal);
 ...
 $result5 = $DB->Row("SELECT type, adult_content, bigimage, files.approved FROM files WHERE uid='".$Data['id']."' AND type='photo' and adult_content !='yes' and approved ='yes' and featured ='yes' ORDER BY `default` DESC LIMIT 1");
		...
		//$image_url = DB_DOMAIN."inc/tb.php?src=".$result5['bigimage']."&x=150&y=150&x=100&y=100";
