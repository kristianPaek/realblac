...
class eMeeting_Thumbnail {
    ...
    function eMeeting_Thumbnail($fileName) {
	...
	function createReflection($percent,$reflection,$white,$border = true,$borderColor = '#a4a4a4') {
        ...
        $colorToPaint = ImageColorAllocateAlpha($this->workingImage,238,238,238,0);
        ...
        for($i=0;$i<$reflectionHeight;$i++) {
            $colorToPaint = imagecolorallocatealpha($this->workingImage,238,238,238,($i/$reflectionHeight*-1+1)*$white);
