...
function GetCouponByCode()
{
    ...
    Timer_Icon('couponMsg');

    eMeetingDo('../../meet/inc/ajax/_actions.php?action=GetCoupon&id='+a,"couponMsg");

    //document.getElementById('couponId').innerHTML = '123';
}
...
function CheckNullsMessages(){
	if((document.getElementById('SendTo').value =="") || (document.getElementById('SentSubject').value =="") || (document.getElementById('formMessage').value =="")){
...
function CheckNullsWinkMessages(){
	if(document.getElementById('SendTo').value ==""){
		document.getElementById('response_message').innerHTML ="Please complete all the fields";
		return false;
	}
