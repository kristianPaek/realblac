...
<b><center><div style="font-size:16px; color:#000000; margin-top:20px;" >Hello <?=$_SESSION['username'] ?> you have<br /> <? if(D_MESSAGES ==1){ ?><a href="<?=DB_DOMAIN ?>mobile.php?dll=mobilemessages&sub=inbox" style="text-decoration:none;font-size:17px;"><u>
...
<br/ ><font color="#F00056">We are celebrating our launch by extending a 50% discount on VIP upgrades for a limited-time only. Make sure you go VIP today!</font></center>
    </dt>
...
<br /> Site Updates: <br /> 
1. We have implemented an auto-rotate feature to align your photos correctly, Visit (My Photos). <br /> 
2. Fixed the photo size issue. Previously uploaded photos may be distorted. Please upload new photos if your profile has been affected. <br /> 
3. New email messaging system for a better user experience.<br /> <br />
...
<br />
<center><i><b>More features available on our desktop version.</i></center>
<? } ?>
