...
<!-- END BOX -->
<form method="post" action="<?=DB_DOMAIN ?>index.php?redirect=yes"  onSubmit="return CheckNullsMessages();" enctype="multipart/form-data">
...
<hr>
	...
	<div id="Search">
		<span class="a1">
			...
			<select name="sto" onchange="location.href='index.php?dll=messages&sub='+this.value;" style="width:150px;font-size:13px;">
