...
<center>	
		...
		<div class="AlbumFilePic"><a href="<?=DB_DOMAIN ?>mobile.php?dll=mobilegallery&sub=manage&aid=<?=$value['aid'] ?>"><img src="<?=$value['image'] ?>"></div>
...
<span id="response_gallery" class="responce_alert"></span>
		...
		<style>
#FolderBody .PicFramebody, .AlbumFilePic{
		padding:0px;height:200px;width:130px;
	}
			...
			<div id='File_<?=$value['id'] ?>'>		
				<li  style="background:white; height:250px;">
							...
							<small style="font-size:16px;">
								...
								<br/>[ <a href='#' onclick="Effect.Fade('File_<?=$value['id'] ?>'); DeleteFile('<?=$value['id'] ?>'); return false;"><?=$GLOBALS['_LANG']['_delete'] ?></a> ]
							</small>	
