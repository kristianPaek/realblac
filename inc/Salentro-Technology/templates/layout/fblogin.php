...
<div style="width:340px;float:left">
	...
	<div class="CapBody">                
<li>
 <a href="<?=DB_DOMAIN ?><?=$showpage ?>?dll=fblogin"><img src="<?=DB_DOMAIN ?>images/facebook-login.jpg" ></a><br />
</li>
...
<? if ($MOBILE == "no") { ?>
 <a href="<?=DB_DOMAIN ?><?=$showpage ?>?dll=fbregister"><img src="<?=DB_DOMAIN ?>images/facebook-register.jpg" ></a><br />
<br>
<? } ?>


<h3><?=$GLOBALS['LANG_WELCOME']['_join'] ?></h3><p> <?=$GLOBALS['LANG_WELCOME']['_join1'] ?> </p>  <a class="MainBtn" href="<?=DB_DOMAIN ?><?=$showpage ?>?dll=<?=$regpage ?>"><span><?=$GLOBALS['LANG_WELCOME']['_join2'] ?></span></a> <div class="ClearAll"></div>
</div> <br>
	<!-- DISPLAY FORGOT BOX -->
