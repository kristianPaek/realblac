...
<tr>
<td width="100%"><p><strong><font size="2"><?=substr($profileUsername,0,30) ?> </font></strong></p>
Last login was <?=showTimeSince($MyProfileGlobals['lastlogin']) ?>
</td></tr>
<? if(D_MOD_WRITE ==1){ ?>
 <tr>
  <td><strong><?=$GLOBALS['_LANG']['_pLink'] ?></strong></td>
    <td><a href="<?=DB_DOMAIN.$MyProfileGlobals['username'] ?>" target="_blank" style="color:#666666"><strong><?=DB_DOMAIN.$MyProfileGlobals['username'] ?></strong></a><br />
</td>
  </tr>
<? } ?>
</table>
...
This member's last login was <br />about <?=showTimeSince($MyProfileGlobals['lastlogin']) ?>
	...
	<script type="text/javascript">
			...
			// <![CDATA[
			var so = new SWFObject(noCacheIE("<?=DB_DOMAIN ?>inc/exe/flash/profile_image.swf"), "ProfileImage", "400", "350", "12", "<?=$F1bg ?>");
			so.addParam("wmode", "opaque");
			so.addParam("scale", "noscale");		
			so.addVariable("xmlSource", "<?=DB_DOMAIN ?>inc/XML/xml_profile_images.php?uid=<?=$profileId ?>");
			so.addVariable("maxArticles", "10");
