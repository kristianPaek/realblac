...
class autokeyword {
	...
	function autokeyword($params, $encoding)
	{
		...
		if($encoding =="windows-1250" || $encoding =="WINDOWS-1250" || $encoding =="windows-1256"){ $encoding="utf-8"; }
